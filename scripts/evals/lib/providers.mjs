...
export function createProviderWrapper(provider, realExecutable, model, effort) {
...
export function vanillaClaudeArgs(prompt) {
  return [
    '-p',
    '--permission-mode',
    'bypassPermissions',
...
export function vanillaCodexArgs(prompt) {

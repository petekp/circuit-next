...
export const SweepResultReportId = z.enum([
  'sweep.brief',
  'sweep.analysis',
  'sweep.queue',
  'sweep.batch',
...
export type SweepResultReportId = z.infer<typeof SweepResultReportId>;

export const SweepResultReportPointer = z
  .object({
...
export type SweepResultReportPointer = z.infer<typeof SweepResultReportPointer>;
...
export const SweepResult = z
  .object({
    ...
    evidence_links: z.array(SweepResultReportPointer).length(6),
  })
  .strict()
  .superRefine((result, ctx) => {
    const seen = new Set<SweepResultReportId>();

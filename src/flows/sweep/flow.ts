...
export const sweepFlowDefinition = defineFlow({
  id: 'sweep',
  visibility: 'public',
  paths: {
  ...
  schematic: {
    ...
    purpose:
      'Sweep flow: frame the sweep, survey for candidates, triage by confidence and risk, execute a batch of acted items, verify no regression, review for scope creep or regressions, and close with evidence. The first version runs one honest batch while keeping the stage path ready for broader batch orchestration.',
    status: 'active',
    version: '0.1.0',

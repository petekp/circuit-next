import { FlowBlockCatalog, type FlowBlockId } from './flow-blocks.js';
  ...
  blocks: [
    ...
    },
    {
      ...
      check: {
        kind: 'command',
        description:
          'Each verification command must have a captured exit status and bounded output.',
      },
      allowed_routes: ['continue', 'retry', 'ask', 'stop'],
      human_interaction: 'optional',
      host_capabilities: {
...
export const FLOW_BLOCK_SCHEMATIC_POLICY = {
  intake: { executionKinds: ['compose', 'checkpoint', 'sub-run', 'fanout'], stages: ['frame'] },
  route: { executionKinds: ['compose', 'checkpoint', 'sub-run', 'fanout'], stages: ['frame'] },
  frame: { executionKinds: ['compose', 'checkpoint', 'sub-run', 'fanout'], stages: ['frame'] },
  'human-decision': { executionKinds: ['checkpoint'], stages: CANONICAL_STAGES },
  'gather-context': { executionKinds: ['relay', 'compose', 'fanout'], stages: ['analyze'] },
  diagnose: { executionKinds: ['relay', 'compose', 'fanout'], stages: ['analyze'] },
  plan: { executionKinds: ['relay', 'compose', 'fanout'], stages: ['plan'] },
  act: { executionKinds: ['relay', 'compose', 'fanout'], stages: ['act'] },
  'run-verification': { executionKinds: ['verification'], stages: ['verify'] },
  review: { executionKinds: ['relay', 'compose', 'fanout'], stages: ['review', 'analyze'] },
  pursue: { executionKinds: ['compose', 'checkpoint', 'sub-run', 'fanout'], stages: ['frame'] },
  'coordinate-pursuits': {
    executionKinds: ['compose', 'checkpoint', 'sub-run', 'fanout'],
    stages: ['plan'],
  },
  queue: { executionKinds: ['compose', 'checkpoint', 'sub-run', 'fanout'], stages: ['plan'] },
  batch: { executionKinds: ['compose', 'checkpoint', 'sub-run', 'fanout'], stages: ['act'] },
  'risk-rollback-check': {
  ...
  handoff: { executionKinds: ['compose', 'checkpoint', 'sub-run', 'fanout'], stages: ['close'] },
} satisfies Record<FlowBlockId, FlowBlockSchematicPolicy>;

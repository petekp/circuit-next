...
// Event + Snapshot bootstrap-shape parity checks.
//
// Split from the original `schema-parity.test.ts` mega-file as part
// of FU-T09.

import { describe, expect, it } from 'vitest';
import { Event, RunLog, RunProjection, SelectionOverride, Snapshot } from '../../src/index.js';
import {
  RUN_A,
  RUN_B,
  bootstrapAt,
  ...
  runClosed,
  stepEntered,
} from '../helpers/runlog-builders.js';
